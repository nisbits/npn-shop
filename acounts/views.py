...
def register(request):
    if request.method == "POST":
        ...
        return render(request,"acounts/registration.html")    
...
def about(request):
    ...
    return render(request,"fileupload/about.html")

def contactus(request):
    
    return render(request,"fileupload/contactus.html")
    

def test(request):
    
    return render(request,"fileupload/test.html")